...
})([".card{margin-bottom:15px;}.card-body{padding:0;}.card-header{display:flex;direction:row;justify-content:space-between}i{color:#548DD4;cursor:pointer}i:hover{color:#0056b3;}.PropertyListActions i{margin-right:10px}.PropertyListForm{padding-left:15px;padding-right:15px;}"]);
...
//# sourceMappingURL=property-list.js.c6e150d2fb998441571c.hot-update.js.map